...
def test_simple_html() -> None:
    ...
    countingResult = word_counter("htmlTest.html")
...
def test_empty_file_html() -> None:
    ...
    countingResult = word_counter("emptyHTML.html")
...
def test_no_content_html() -> None:
    ...
    countingResult = word_counter("noContentHTML.html")
...
def test_file_with_only_nltk_html() -> None:
    ...
    countingResult = word_counter("all_nltk_text.html")
